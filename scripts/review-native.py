...
parser.add_argument('--cases', default='A1,A2,A3,A4,A5,A6,D3,D4,D5,D6,movement,restoration,frame,pointer,rename,disconnected,tracking,Startup,StartupMany,Minimized,Animations,RestoreReady')
args = parser.parse_args()
binary = Path(args.binary).resolve()
out = Path(args.output).resolve()
out.mkdir(parents=True, exist_ok=True)
smokes = {'tabs': '--tabs-smoke', 'polish': '--frame-smoke', 'movement': '--movement-fixture', 'restoration': '--restoration-fixture', 'frame': '--frame-smoke', 'pointer': '--pointer-smoke', 'rename': '--rename-smoke', 'disconnected': '--disconnected-smoke', 'tracking': '--tracking-smoke', 'design': '--design-smoke', 'surface': '--surface-smoke', 'settings': '--ui-smoke'}
review = {'prerequisite', 'A1', 'A2', 'A3', 'A4', 'A5', 'A6', 'D3', 'D4', 'D5', 'D6', 'Minimized', 'Startup', 'StartupMany', 'Animations', 'RestoreReady'}
